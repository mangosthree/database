...
set PAD=""
if %locIT% == NO set PAD=" "
echo %colWhiteBold%^|                          %colYellowBold%I - %colYellow%Toggle Italian (%colWhiteBold%%locIT%%colYellow%)%colReset%                           %PAD:"=%%colWhiteBold%^|

set PAD=""
if %locPT% == NO set PAD=" "
echo %colWhiteBold%^|                          %colYellowBold%P - %colYellow%Toggle Portuguese (%colWhiteBold%%locPT%%colYellow%)%colReset%                        %PAD:"=%%colWhiteBold%^|

set PAD=""
if %locBR% == NO set PAD=" "
echo %colWhiteBold%^|                          %colYellowBold%B - %colYellow%Toggle Brazilian (%colWhiteBold%%locBR%%colYellow%)%colReset%                         %PAD:"=%%colWhiteBold%^|
...
if %activity% == i goto ToggleLocIT:
if %activity% == B goto ToggleLocBR:
if %activity% == b goto ToggleLocBR:
if %activity% == P goto ToggleLocPT:
if %activity% == p goto ToggleLocPT:
...
if %locIT% == YES set LOCList=YES
if %locPT% == YES set LOCList=YES
if %locBR% == YES set LOCList=YES
goto main:
...
%dbClientConnectionString% %wdb% < Translations\Translations\French\French_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\German\German_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Korean\Korean_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Chinese\Chinese_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Taiwanese\Taiwanese_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish\Spanish_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_achievement_reward.sql
echo  .... Command (2/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_CommandHelp.sql
echo  .... Creatures (3/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Creature.sql
echo  .... Creature AI Texts (4/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Creature_ai_texts.sql
echo  .... DB Script Strings (5/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_db_script_string.sql
echo  .... GameObjects (6/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Gameobject.sql
echo  .... Gossip Texts (7/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Gossip_texts.sql
echo  .... Gossip Menu Option (8/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Gossip_Menu_option.sql
echo  .... Items (9/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Items.sql
echo  .... Mangos String (10/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Mangos_String.sql
echo  .... PageText (11/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_PageText.sql
echo  .... Points of Interest (12/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Points_of_interest.sql
echo  .... Quests (13/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Quest.sql
echo  .... Script Texts (14/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_Script_Texts.sql
echo  .... NpcText (15/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Spanish_South_American\Spanish_South_American_NpcText.sql
goto LocWorldDB7:
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Russian\Russian_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Italian\Italian_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Portuguese\Portuguese_achievement_reward.sql
echo  .... Command (2/15)
...
echo %colWhiteDarkYellow%^|_____________________________________________________________________________^|%colReset%
echo  .... Achievement (1/15)
%dbClientConnectionString% %wdb% < Translations\Translations\Brazilian\Brazilian_achievement_reward.sql
echo  .... Command (2/15)
