...
BEGIN
    ...
    SET @cNewComment = 'YTDB (r73) + CMANGOS (up to and incl. c13123) updates';
...
--
-- Host: localhost    Database: mangosThree
-- ------------------------------------------------------
...
CREATE TABLE `creature_linking` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Creature Linking System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Creature waypoint system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature_template_spells` (
  ...
  PRIMARY KEY (`entry`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Creature System (Spells used by creature)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dbdocsfields` (
  ...
  KEY `fieldId` (`fieldId`)
) ENGINE=InnoDB AUTO_INCREMENT=1570 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Vehicle Accessory (passengers that are auto-boarded onto a v';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-08-05  9:57:19
