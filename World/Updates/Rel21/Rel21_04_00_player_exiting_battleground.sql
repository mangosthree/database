...
BEGIN
    ...
    SET @cNewDescription = 'battleground_template';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'battleground_template new column added';
 ...
 -- (cmangos update) Check player exiting waiting area while starting battleground
 -- this requires the new column, StartMaxDist added to the battleground_template table
