...
ALTER TABLE gameobject ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE gameobject_addon ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
-- ALTER TABLE phase_definitions ROW_FORMAT=DYNAMIC ENGINE=INNODB;
