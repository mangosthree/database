...
-- Delete unspawned obsolete transports
DELETE FROM gameobject_template WHERE entry IN (
    21653, 21654, 21655, 21656, 32056, 32057, 80024, 176086,
    192550, 192551, 193458, 193459, 193460, 193461,
    194030, 194031, 194582, 194583, 194584, 194585, 194586,
    194587, 203251, 203303, 203304, 204242
);
...
DELETE FROM `spell_script_target` WHERE `entry`=63282 and `type`=1;
INSERT INTO `spell_script_target` (`entry`, `type`, `targetEntry`, `inverseEffectMask`)
VALUES
(63282, 1, 32927, 0);

DELETE FROM `disables` WHERE `entry`=70085;
INSERT INTO `disables` (sourceType, entry, flags, data, comment)
VALUES (0, 70085, 0, 0, 'Missing EffectTriggered handler');

DELETE FROM `disables` WHERE `entry`=50162;
INSERT INTO disables (sourceType, entry, flags, DATA, COMMENT)
VALUES (0, 50162, 0, 0, 'Missing EffectTriggered handler');
