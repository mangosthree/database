...
BEGIN
    ...
    SET @cNewDescription = 'Hyjal_Druid_Talon_Auras';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Drop redundant 40121+40122 from creature_addon.auras; Storm Crow Form 77042 auto-applies both, was log spam';
...
-- Storm Crow Form (77042) already applies 40121 and 40122 itself. Listing them
-- again in creature_addon.auras makes the core re-apply auras the shapeshift owns,
-- which just logs a warning for every one of these druids on spawn.
UPDATE `creature_addon` SET `auras`='77042'
    WHERE `guid` IN (285641, 285655, 293706);
