...
BEGIN
	...
	DELETE FROM `conditions` WHERE `condition_entry` = 8335;
	...
	(8335,-2,@condition+2,@condition+3,'NPC text display - check q.8347 taken/completed');
	...
	UPDATE `npc_text` SET `text0_0` = 'If you have not spoken to Magistrix Erona at the Sunspire. I recommend you do so immediately. There are pressing matters to attend to, and she - as do we all - need your help!', `prob0` = 1, `em0_0` = 1 WHERE `ID` = 7868;
