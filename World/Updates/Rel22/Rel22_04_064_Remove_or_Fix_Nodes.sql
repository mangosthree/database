...
BEGIN
    ...
    SET @cNewDescription = 'Remove_or_Fix_Nodes';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Remove_or_Fix_Nodes';
    ...
    -- School of Deviate Fish above water level in Lushwater Oasis (Northern Barrens). At old water level pre 4.x.x.
DELETE FROM `gameobject` WHERE `guid` = 42434;

-- Bring down a floating Copper Vein in Northern Barrens.
