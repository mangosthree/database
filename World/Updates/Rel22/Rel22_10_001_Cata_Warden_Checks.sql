...
BEGIN
    ...
    IF (@cCurVersion = @cOldVersion
        ...
        -- Publish the exact Cataclysm 4.3.4.15595 x86 Warden catalogue.
        -- The x64 module remains compatibility-probe-only here.
        ...
        -- The standard CONTINUE handler must not let a failed preflight reach
        -- this destructive rebuild.
        ...
        -- CREATE TABLE implicitly committed the outer template transaction.
        -- Restart it so the catalogue rows and version marker remain atomic.
        START TRANSACTION;
