...
(269, 0, 0, 0, 0, 10285, 10285, 0, 'You must complete the quest "Return to Andormu" before entering the Black Morass.', 'Caverns Of Time,Black Morass (Entrance)'), -- removed in Cata: item 30635 key-of-time
...
(540, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Shattered Halls (Entrance)'), -- removed in Cata: items 30637 flamewrought-key, 30622 flamewrought-key
(542, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Blood Furnace (Entrance)'),
(543, 1, 0, 0, 0, 0, 0, 0, NULL, 'Hellfire Ramparts (Entrance)'),
(545, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Steamvault (Entrance)'), -- removed in Cata: item 30623 reservoir-key
(546, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Underbog (Entrance)'),
(547, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Slave Pens (Entrance)'),
(552, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Arcatraz (Entrance)'), -- removed in Cata: 30634 warpforged-key
(553, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Botanica (Entrance)'),
(554, 1, 0, 0, 0, 0, 0, 0, NULL, 'The Mechanar (Entrance)'),
(555, 1, 0, 0, 0, 0, 0, 0, NULL, 'Shadow Labyrinth (Entrance)'), -- removed in Cata: 30633 auchenai-key
...
(560, 1, 0, 0, 0, 0, 0, 0, NULL, 'Caverns Of Time,Old Hillsbrad Foothills (Entrance)'), -- removed in Cata: 30635 key-of-time
