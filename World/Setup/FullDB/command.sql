...
(20,'additem',2,'Syntax: .additem #itemid/[#itemname]/#shift-click-item-link #itemcount\r\n\r\nAdds the specified number of items of id #itemid (or exact (!) name $itemname in brackets, or link created by shift-click at item in inventory or recipe) to your or selected character inventory. If #itemcount is omitted, only one item will be added.'),
...
(277,'learn all_crafts',3,'Syntax: .learn crafts\r\n\r\nLearn all professions and recipes.'),
(278,'learn all_default',1,'Syntax: .learn all_default [$playername]\r\n\r\nLearn for selected/$playername player all default spells for his race/class and spells rewarded by completed quests.'),
(279,'learn all_gm',3,'Syntax: .learn all_gm\r\n\r\nLearn all default spells for Game Masters.'),
(280,'learn all_lang',3,'Syntax: .learn all_lang\r\n\r\nLearn all languages'),
...
(346,'modify aspeed',1,'Syntax: .modify aspeed #rate Modify all speeds -run,swim,run back,swim back- of the selected player to \r normal base speed for this move type\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
(347,'modify bwalk',1,'Syntax: .modify bwalk #rate Modify the speed of the selected player while running backwards to \r normal walk back speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
(348,'modify currency',2,'Syntax: .modify currency $id $amount\r\n\r\nAdd $amount points of currency $id to the selected player.'),
(349,'modify drunk',1,'Syntax: .modify drunk #value\r\n\r\nSet drunk level to #value (0..100). Value 0 remove drunk state, 100 is max drunked state.'),
(350,'modify energy',3,'Syntax: .modify energy #energy\r\n\r\nModify the energy of the selected player. If no player is selected, modify your energy.'),
(351,'modify faction',3,'Syntax: .modify faction #factionid #flagid #npcflagid #dynamicflagid\r\n\r\nModify the faction and flags of the selected creature. Without arguments, display the faction and flags of the selected creature.'),
...
(365,'modify speed',1,'Syntax: .modify speed #rate.speed #rate Modify the running speed of the selected player to \r normal base run speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
(366,'modify standstate',2,'Syntax: .modify standstate #emoteid\r\n\r\nChange the emote of your character while standing to #emoteid.'),
(367,'modify swim',1,'Syntax: .modify swim #rate Modify the swim speed of the selected player to \r normal swim speed\"\"*rate. If no player is selected, modify your speed. #rate may range from 0.1 to GM.MaxSpeedFactor defined in mangosd.conf.\"'),
...
(802,'wp import',3,'Syntax: .wp import $filename'),
