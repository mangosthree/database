...
INSERT INTO `achievement_reward` (`entry`, `gender`, `title_A`, `title_H`, `item`, `sender`, `subject`, `text`) VALUES (45,2,0,0,43348,28070,'You\'ve Been Around!','Well, look at ye!$b$bAnd I thought I had seen some things in this icy place! It seems obvious to this dwarf that you have the fire of the explorer burning in your eyes.$b$bWear this tabard with pride. That way your friends will know who to ask for directions when the time comes!$b$bKeep on the move!$b$b-Brann Bronzebeard'),
...
-- Dump completed on 2015-01-24 21:52:38
