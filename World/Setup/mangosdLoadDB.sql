...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Achievment system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `command` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=814 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Chat System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=57811 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Condition System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=400050 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature_ai_scripts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27383157 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='EventAI Scripts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature_ai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='EventAI Summoning Locations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=375556 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7833712 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Dungeon Finder Requirements';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1719 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Tele Command';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gameobject` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=515631 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Gameobject System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gossip_texts` (
  ...
  `comment` text DEFAULT NULL COMMENT 'Textual comment.',
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Gossip Texts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_enchantment_template` (
  `entry` mediumint(8) NOT NULL DEFAULT 0 COMMENT 'Random property type (See item_template.RandomProperty).',
...
CREATE TABLE `item_template` (
  ...
  `delay` int(10) NOT NULL COMMENT 'The delay in milliseconds between successive hits for the item.',
...
CREATE TABLE `locales_command` (
  ...
  `help_text_loc9` varchar(100) DEFAULT NULL,
  `help_text_loc10` varchar(100) DEFAULT NULL,
  `help_text_loc11` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='GM Commands localized help';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locales_points_of_interest` (
  ...
  `icon_name_loc9` text DEFAULT NULL,
  `icon_name_loc10` text DEFAULT NULL,
  `icon_name_loc11` text DEFAULT NULL,
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mangos_string` (
  ...
  `content_loc9` text DEFAULT NULL,
  `content_loc10` text DEFAULT NULL,
  `content_loc11` text DEFAULT NULL,
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `npc_vendor` (
  ...
  `maxcount` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Items available.',
...
CREATE TABLE `quest_template` (
  ...
  `RequiredRaces` int(7) unsigned NOT NULL DEFAULT 0 COMMENT 'Required races mask.',
  `RequiredSkill` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Required skill type.',
  ...
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Quest System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `script_binding` (
  ...
  KEY `type` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='SD2 Script Names and Binding';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spell_learn_spell` (
  ...
  `SpellID` mediumint(8) unsigned NOT NULL DEFAULT 0 COMMENT 'Spell ID (See Spell.dbc).',
...
CREATE TABLE `spell_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='MaNGOS server side spells';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Vehicle Accessory (passengers that are auto-boarded onto a vehicle)';
/*!40101 SET character_set_client = @saved_cs_client */;
