...
ALTER TABLE auction MODIFY COLUMN `buyoutprice` BIGINT(40) NOT NULL DEFAULT '0' COMMENT 'The buyout price of the item in copper.';
ALTER TABLE auction MODIFY COLUMN `deposit` BIGINT(40) NOT NULL DEFAULT '0' COMMENT 'The amount of copper spent on the deposit.';
...
ALTER TABLE auction MODIFY COLUMN `lastbid` BIGINT(40) NOT NULL DEFAULT '0' COMMENT 'The amount of copper of the last bid made on the item.';
ALTER TABLE auction MODIFY COLUMN `startbid` BIGINT(40) NOT NULL DEFAULT '0' COMMENT 'The amount of copper of the starting bid made on the item.';
...
ALTER TABLE characters MODIFY COLUMN `money` BIGINT(40) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'This is the amount of copper the character possesses.';
...
ALTER TABLE mail MODIFY COLUMN `cod` BIGINT(40) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Amount of money needed (COD).';
...
ALTER TABLE mail MODIFY COLUMN `money` BIGINT(40) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Amount of money sent.';
