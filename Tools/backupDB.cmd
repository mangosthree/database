...
REM mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% creature_equip_template_raw >  _full_db\creature_equip_template_raw.sql
mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% creature_involvedrelation >  _full_db\creature_involvedrelation.sql
REM mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% creature_item_template >  _full_db\creature_item_template.sql
...
mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% hotfix_data >  _full_db\hotfix_data.sql
...
REM mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% petcreateinfo_spell >  _full_db\petcreateinfo_spell.sql
...
mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% quest_phase_maps >  _full_db\quest_phase_maps.sql
...
REM mysqldump -Q -c -e -q -u%Username% -p%Password% -h %SERVER% %DB% spell_affect >  _full_db\spell_affect.sql
